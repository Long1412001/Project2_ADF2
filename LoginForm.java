...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void login_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btnMouseClicked
        ...
        if(librarian.isSelected()){
            func = librarian.getText();
        }
        else if(bookmanager.isSelected()){
            func = bookmanager.getText();
        }
        if(uname.equals("") || pass.equals("") || (!librarian.isSelected() && !bookmanager.isSelected())){
            ...
            try{
                adminFunction admin = new adminFunction(uname, adminFunction.SHA1(pass), adminFunction.checkFunction(func));
                if(admin.checkLogin() && func.equals("Librarian")){
                ...
                else if(admin.checkLogin() && func.equals("Book Manager")){
                    TestForm form = new TestForm();
                    form.setVisible(true);
                    form.pack();
                    form.setLocationRelativeTo(null);
